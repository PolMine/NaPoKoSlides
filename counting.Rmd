...
subtitle: "Workshop 'Text Mining politischer Kommunikation'"
author: "Andreas Blaette"
date: "Stand: 7. Februar 2019"
output:
...
- Zählen = Messen. Damit stellt sich die Frage nach der Validität! Ist sichergestellt, dass ich messe, was ich meine zu messen?

- Absoluten Häufigkeiten (`count`) vs. relative Frequenzen (`frequencies`, Normalisierung der Häufigkeit durch Division mit Korpus- bzw. Subkorpusgröße, meist als `freq` abgekürzt).
